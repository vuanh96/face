...
MODEL_FILE = caffe_root + 'models/face_12c/deploy.prototxt'
PRETRAINED = caffe_root + 'models/face_12c/face_12c_train_iter_400000.caffemodel'
caffe.set_mode_gpu()
...
PRETRAINED = caffe_root + 'models/face_48_cal/face_48_cal_train_iter_390000.caffemodel'
caffe.set_mode_gpu()
